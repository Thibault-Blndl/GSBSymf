 ...
 */
final class Version20210505121121 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE acteurs_fiche_frais (acteurs_id INT NOT NULL, fiche_frais_id INT NOT NULL, INDEX IDX_7CC3AEA7D94F5755 (fiche_frais_id), INDEX IDX_7CC3AEA771A27AFC (acteurs_id), PRIMARY KEY(acteurs_id, fiche_frais_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE fiche_frais_acteurs (fiche_frais_id INT NOT NULL, acteurs_id INT NOT NULL, INDEX IDX_E3489ABE71A27AFC (acteurs_id), INDEX IDX_E3489ABED94F5755 (fiche_frais_id), PRIMARY KEY(fiche_frais_id, acteurs_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
